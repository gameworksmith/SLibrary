...
namespace SLibrary.NetSocket
{
    ...
    private static extern string getIPv6(string mHost, string mPort);
        ...
        private static void getIPType(String serverIp, String serverPorts, out String newServerIp,
            out AddressFamily ipType)
        {
            // IP 版本 4 地址
     ...
     * Http(使用 Socket 方式)
     */
        public static System.Net.Sockets.Socket createSocket(ref string ip, string port)
        {
            String newServerIp = "";
            ...
            var socket = new System.Net.Sockets.Socket(newAddressFamily, SocketType.Stream, ProtocolType.Tcp);
            return socket;
        }
